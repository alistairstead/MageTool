...
class CacheClearCommand extends ObjectBehavior
{
    ...
    public function it_should_return_name_from_getName($input, $output)
    {
     ...
     */
    public function it_should_return_success_from_execute($input, $output)
    {
     ...
     */
    public function it_should_clear_cache($input, $output, $container, $app, $cacheInstance)
    {
